...
cat $DIR/head.py <(echo) $T/abbr.py <(echo) $T/printerTools.py <(echo) $T/debugTools.py <(echo) $T/parseTools.py <(echo) $T/mathTools.py <(echo) $T/algoTools.py <(echo) $DIR/tail.py > $DIR/Solution.py
