...
#
# For example:
# python interactive_runner.py python local_testing_tool.py 0 -- ./my_binary
#
# This will run the first test set of a python judge called "local_testing_tool.py"
...
sys.exit(t_judge.return_code | t_sol.return_code)
